        ...
        <div className="flex flex-col justify-center items-center text-center gap-8 h-full md:items-start md:text-left">
         ...
         Prestige Gardenia – Premium Plotted Development in Devanahalli <p>The plotted development extends over an area of 50 acres and hosts the best plots of dimension range of 1,500 sq ft to 4,000 ft in the heart of the city. </p>
          ...
          <br />
            ...
            <br/>
            <p>These ready to build plots in Bangalore come with wide internal roads and underground utilities Whether you’re planning to construct your dream home or invest in residential plots near Bangalore Airport.</p>
