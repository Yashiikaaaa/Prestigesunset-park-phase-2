...
export const Features = () => {
  ...
  const featuresData = [
    { id: 1, title: 'Project Size', value: '17 Acres' },
    { id: 2, title: 'Possession', value: 'Dec 2027 (onwards)' },
    { id: 3, title: 'Starting Price', value: 'Rs 1.75 Cr*' },
    { id: 4, title: 'Available Units', value: '3 & 3.5 BHK' },
  ];
